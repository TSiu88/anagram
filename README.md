# _[Anagram](https://github.com/TSiu88/anagram)_

#### _Anagram Checker, 03.3.2020_

#### By _**Tiffany Siu and Jack Dunning**_

[![Project Status: Inactive – The project has reached a stable, usable state but is no longer being actively developed; support/maintenance will be provided as time allows.](https://www.repostatus.org/badges/latest/inactive.svg)](https://www.repostatus.org/#inactive)
![LastCommit](https://img.shields.io/github/last-commit/tsiu88/anagram)
![Languages](https://img.shields.io/github/languages/top/tsiu88/anagram)
...
This console application was written for Epicodus Intro to Programming and C#/React course.  It practices using MSTest and checks if a word is an anagram or not.
...
2. Clone the [repository](https://github.com/TSiu88/anagram.git) from my [GitHub page](https://github.com/TSiu88)
